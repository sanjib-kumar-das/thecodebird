      ...
      >
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            The Code Bird also referred to as "Code Bird" is the Coding Club of
            University Institute of Technology Burdwan. It is a student
            community aimed to foster coding culture existing inside University
            Institute of Technology Burdwan. The Club was founded on 23rd
            August, 2016 under the guidance of our esteemed mentor Professor
            Sumit Gupta. Since then The Code Bird has been evolved into the ever
            growing community of Coders at UIT, BU. It is the place where
            institute's Best Coders lead to create pathways for the UITians.
          </p>
          ...
          <div className="row mt-2 mb-2">
            ...
            <div className="col-md-4 d-flex justify-content-around">
              ...
              >
                ...
                <div className="card-body">
                  <h5 className="card-title">
                    Abhishek Mishra <span class="badge bg-primary"> CSE </span>
                  </h5>
                  <p className="card-text text-truncate">2014-18</p>
                  <hr className="dropdown-divider" />
                  <h6>POSITION: Core Committee Member</h6>
          ...
          <div className="row mt-2 mb-2">
            ...
            <div className="col-md-4 d-flex justify-content-around">
              ...
              >
                ...
                <div className="card-body">
                  <h5 className="card-title">
                    Navneet Prashant <span class="badge bg-primary"> CSE </span>
                  </h5>
                  <p className="card-text text-truncate">2015-19</p>
                  <hr className="dropdown-divider" />
                  <h6>POSITION: Core Committee Member</h6>
          ...
          <div className="row mt-2 mb-2">
            <div className="col-md-4 d-flex justify-content-around">
              ...
              >
                ...
                <div className="card-body">
                  <h5 className="card-title">
                    Mohtasheem Ejaz <span class="badge bg-primary"> CSE </span>
                  </h5>
            ...
            <div className="col-md-4 d-flex justify-content-around">
              ...
              >
                ...
                <div className="card-body">
                  <h5 className="card-title">
                    Amrit Dhandharia <span class="badge bg-primary"> CSE </span>
                  </h5>
                  <p className="card-text text-truncate">2014-18</p>
                  <hr className="dropdown-divider" />
                  <h6>POSITION: Core Committee Member</h6>
            ...
            <div className="col-md-4 d-flex justify-content-around">
              ...
              >
                ...
                <div className="card-body">
                  <h5 className="card-title">
                    Sanjib Kumar Das <span class="badge bg-primary"> CSE </span>
                  </h5>
                  <p className="card-text text-truncate">2014-18</p>
                  <hr className="dropdown-divider" />
                  <h6>POSITION: Core Committee Member</h6>
